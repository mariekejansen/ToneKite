 ...
 * This file demonstrates how to integrate Tonekite with a web frontend
 */

// For React/Vue/Angular applications
export class TonekiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TonekiteClient(provider, contractAddress);
